...
(defmethod process (s (command (eql 'signout)) postlines)
  ...
  (format s "Set-Cookie: user=false; path=/; expires=Wednesday, 09-Nov-99 23:12:40 GMT") (crlf s) ; *client*) (crlf s)
  (format s "Set-Cookie: nonce=false; path=/; expires=Wednesday, 09-Nov-99 23:12:40 GMT") (crlf s) ; *client*) (crlf s)
  (crlf s)
  (format-html s) (crlf s)
  (format s "<head>")
