...
(defun white-tests ()
'(
  (smf "http://herge.sisl.rites.uic.edu/notamper/instrumented/smf/index.php?topic=2.0")
  (landshop2 "http://herge.sisl.rites.uic.edu/notamper/instrumented/landshop/admin/action/login.php")
  (landshop "http://herge.sisl.rites.uic.edu/notamper/instrumented/landshop/admin/action/objects.php?action=new")
  (opendb "http://herge.sisl.rites.uic.edu/notamper/instrumented/opendb/user_admin.php?op=edit&user_id=user1")
  (newspro "http://herge.sisl.rites.uic.edu/notamper/instrumented/newspro/postnews.php?action=post")
  (snipegallery "http://herge.sisl.rites.uic.edu/notamper/instrumented/snipegallery/admin/gallery/gallery.php")
  (sphpblog "http://herge.sisl.rites.uic.edu/notamper/instrumented/sphpblog/setup.php")
  (phpnuke "http://herge.sisl.rites.uic.edu/notamper/instrumented/phpnuke/modules.php?name=Private_Messages&file=index&mode=post")
  (dcpportal "http://herge.sisl.rites.uic.edu/notamper/instrumented/dcp-portal/register.php")
  (mybloggie "http://herge.sisl.rites.uic.edu/notamper/instrumented/mybloggie/admin.php?mode=add")
  (phpnews "http://herge.sisl.rites.uic.edu/notamper/instrumented/phpnews/index.php?action=modifytemp&temp=news")
  ))
